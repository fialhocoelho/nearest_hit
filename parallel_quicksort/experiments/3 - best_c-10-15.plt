...
plot 'c10.dat' using 1:4 t 'n=2^{10}' with linespoints,\
     'c11.dat' using 1:4 t 'n=2^{11}' with linespoints,\
     'c12.dat' using 1:4 t 'n=2^{12}' with linespoints,\
     'c13.dat' using 1:4 t 'n=2^{13}' with linespoints,\
     'c14.dat' using 1:4 t 'n=2^{14}' with linespoints,\
     'c15.dat' using 1:4 t 'n=2^{15}' with linespoints,\
#     'c16.dat' using 1:4 t 'n=2^{16}' with linespoints,\
