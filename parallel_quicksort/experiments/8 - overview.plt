...
set key nobox at 16.9,1.5 font ",22"
set xlabel 'itens' offset 0,1
set ylabel 'speedup' offset 4.3,0
set format x '2^{%.0f}'
...
plot 'performance.dat' using 1: 4 t 'FPSqs' with linespoints ls 2,\
     'performance.dat' using 1: 6 t 'CPSqs' with linespoints ls 3,\
     'performance.dat' using 1: 8 t 'BPSqs' with linespoints ls 7,\
     'performance.dat' using 1:12 t 'FPOqs' with linespoints ls 5,\
     'performance.dat' using 1:14 t 'CPOqs' with linespoints ls 6,\
     'performance.dat' using 1:16 t 'BPOqs' with linespoints ls 8
